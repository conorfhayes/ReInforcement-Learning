...
class Agent:
    ...
    def Agent(self, numStates, numActions, alpha, gamma, epsilon, id):
        ...
        self.maxQ = 0
        self.stateVector = 0
        self.thresholds = self.initialiseThresholds(3, 0, -26500)
        self.action_holder = []
        self.action_ = []
        self.dReward = 0
        self.P1M_array_D = []
    ...
    def compare(self, a, b, thresholds, objective):
        ...
        for i in range(len(thresholds)-1):
            ...
            if a == 0 and b == 0:
                thresholdA = min(a, thresholds[i])
                thresholdB = min(b, thresholds[i])
            ...
            #print("ThresholdA: ", thresholdA)
            #print("ThresholdB: ", thresholdB)
        ...
        if a == 0 and b != 0:
            ...
            return 0
        elif a[len(thresholds)-2] > b[len(thresholds)-2]:
            return 1
        elif a[len(thresholds)-2] < b[len(thresholds)-2]:
            return -1
