...
public class Main {
	...
	public static void main(String[] args) throws IOException
	{
		...
		while (inc <= numRuns )
		{	
			ArrayList<DeepRL_Agent> _agentsGlobal_ = new ArrayList<DeepRL_Agent>();
			int starter = 1;
			...
			{
				DeepRL_Agent agentGlobal = envGlobal.createAgent(starter + 1);
		...
		FileWriter fw_comp = new FileWriter(rewardType + "_" + scalarisation + "_" + "Computation_" + java.time.LocalDate.now() + "_" +  java.time.LocalTime.now());
